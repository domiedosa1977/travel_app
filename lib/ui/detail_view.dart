...
class _DetailViewState extends State<DetailView> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    controller = AnimationController(vsync: this, upperBound: 1, lowerBound: 0, duration: const Duration(milliseconds: 900))..forward();
    super.initState();
  }
  @override
          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              child: FittedBox(
                fit: BoxFit.cover,
                child: Image.asset(
                  _travelList[widget.id].imageUrl[0],
                ),
              ),
            ),
          ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(_travelList[widget.id].description,style: const TextStyle(
